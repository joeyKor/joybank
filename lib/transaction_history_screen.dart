                      ...
                      builder: (context, snapshot) {
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Text(
                              accountNumber,
                              style: TextStyle(color: Colors.black.withOpacity(0.8), fontSize: 16, fontWeight: FontWeight.bold),
                            ),
                            const SizedBox(height: 8),
                            Text(
                      ...
                      return SliverFillRemaining(
                        child: FutureBuilder<DocumentSnapshot>(
                          ...
                          builder: (context, accountSnapshot) {
                            ...
                            final createdAt = (accountData['createdAt'] as Timestamp?)?.toDate();
                            final balance = accountData['balance'] ?? 0;
                                ...
                                ListTile(
                                  ...
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => TransactionDetailScreen(transaction: transaction, transactionId: transactions[index].id), // Pass transactionId
                                      ),
                                    );
                                  },
                                  title: Row(
                                    children: [
                                      Text(
                                        DateFormat('MM.dd').format((transaction['timestamp'] as Timestamp?)?.toDate() ?? DateTime.now()),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (transaction['memo'] != null && transaction['memo'].isNotEmpty) // Display memo
                                              Text(
                                                transaction['memo'],
