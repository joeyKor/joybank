...
class TransactionDetailScreen extends StatefulWidget {
  ...
  const TransactionDetailScreen({super.key, required this.transaction, required this.transactionId});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    isDeposit
                        ? '${_transactionData['senderName'] ?? '알 수 없음'}님으로부터'
                        : '${_transactionData['recipientName'] ?? '알 수 없음'}님께',
    ...
    return Column(
      ...
      children: [
        ...
        _isEditingMemo
            ...
            : Text(
                _transactionData['memo'] != null && _transactionData['memo'].isNotEmpty
                    ? _transactionData['memo']
                    : '메모 없음',
                style: const TextStyle(fontSize: 16, color: Colors.black), // Black when saved
              ),
      ],
    );
  }
